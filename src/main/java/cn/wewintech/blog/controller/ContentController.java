package cn.wewintech.blog.controller;

import cn.wewintech.blog.domain.ContentDO;
import cn.wewintech.blog.service.ContentService;
...
public class ContentController extends BaseController {
	...
	@RequiresPermissions("blog:bContent:add")
	@PostMapping("/save")
	public ResultObject save(ContentDO bContent) {
		...
		if (count > 0) {
			return ResultObject.ok().put("cid", bContent.getCid());
		}
	...
	public ResultObject update( ContentDO bContent) {
		bContent.setGtmCreate(new Date());
	...
	@ResponseBody
	public ResultObject remove(@RequestParam("ids[]") Long[] cids) {
