...
import cn.wewintech.common.utils.StringUtils;
...
import cn.wewintech.common.dao.DictDao;
...
public class DictServiceImpl implements DictService {
	...
	@Override
	public String findNameByValueAndType(String value, String name) {
		DictDO dictDO = new DictDO(value, name);
		String nameString = dictDao.findNameByValueAndType(dictDO);
		return nameString;
	}
