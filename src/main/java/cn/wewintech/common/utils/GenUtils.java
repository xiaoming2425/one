...
import cn.wewintech.common.domain.ColumnDO;
import cn.wewintech.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("templates/common/generator/Dao.xml.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        List<String> movefield = Arrays.asList(config.getStringArray("movefield"));
        //列信息
        List<ColumnDO> columsList = new ArrayList<>();
        List<ColumnDO> columsListMove = new ArrayList<>();
        for (Map<String, String> column : columns) {
            ...
            if (!movefield.contains(column.get("columnName"))) {
            	columsListMove.add(columnDO);
			}
        ...
        map.put("pathName", config.getString("package").substring(
        		config.getString("package").lastIndexOf('.', (config.getString("package").lastIndexOf(".") - 1))+1,config.getString("package").lastIndexOf(".")));
        map.put("columns", tableDO.getColumns());
        map.put("columnsMove", columsListMove);
        ...
        for (String template : templates) {
            ...
            try {
            	...
            	zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassname(), tableDO.getClassName(), 
            			config.getString("package").substring(
            	        		config.getString("package").lastIndexOf('.', (config.getString("package").lastIndexOf(".") - 1))+1))));
