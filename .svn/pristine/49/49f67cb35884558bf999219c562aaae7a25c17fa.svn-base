...
import cn.wewintech.common.service.GeneratorService;
import cn.wewintech.common.utils.GenUtils;
...
public class GeneratorController {
	...
	@ResponseBody
	@PostMapping("/update")
	ResultObject update(@RequestParam Map<String, Object> map) {
		try {
			...
			return ResultObject.error("保存配置文件出错");
		}
