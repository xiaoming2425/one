package cn.wewintech.system.service.impl;
...
import cn.wewintech.system.service.DeptService;
...
import cn.wewintech.system.dao.DeptDao;
import cn.wewintech.system.dao.UserDao;
import cn.wewintech.system.dao.UserRoleDao;
import cn.wewintech.system.domain.DeptDO;
import cn.wewintech.system.domain.UserDO;
import cn.wewintech.system.domain.UserRoleDO;
...
//    @Cacheable(value = "user",key = "#id")
    ...
    public Map<String, Object> updatePersonalImg(MultipartFile file, String avatar_data, Long userId) throws Exception {
        ...
        FileDO sysFile = new FileDO(FileType.fileType(fileName), "/files/" + newFileName, fileName, null,null);
        //获取图片后缀
